...
__title__ = 'item_week_data_file_load_wk2.py'
...
process_name = "ITEM_WEEK_DATA_FILE_LOAD_WK2"
...
v_file_pattern_wk2 = get_param(parameters,parent_process_name, process_name, 'file_pattern_wk2')
...
put_data_into_aws = put_data_into_aws_sql.format(aws_internal_stage_path=v_aws_internal_stage_path,file_path=v_file_path,file_pattern=v_file_pattern_wk2)
...
for file in v_list_dir_files:
 # logger.info('file processing:' + str(file))
  if file.startswith(v_file_pattern_wk2):
